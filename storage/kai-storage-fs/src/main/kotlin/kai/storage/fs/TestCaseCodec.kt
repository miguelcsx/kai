    ...
    private fun encodeBuildConfig(testCase: TestCase): JsonValue {
        ...
        return JsonValue.Obj(
            linkedMapOf(
                ...
                "target" to JsonValue.Str(testCase.buildConfig.target.name),
                "languageVersion" to JsonValue.Str(testCase.buildConfig.languageVersion.value),
                "apiVersion" to JsonValue.Str(testCase.buildConfig.apiVersion.value)
            )
        )
    }
